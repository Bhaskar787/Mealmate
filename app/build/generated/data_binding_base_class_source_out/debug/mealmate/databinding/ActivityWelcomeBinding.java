...
public final class ActivityWelcomeBinding implements ViewBinding {
  ...
  private ActivityWelcomeBinding(@NonNull ConstraintLayout rootView, @NonNull Button logoutButton,
      @NonNull TextView welcomeMessage, @NonNull TextView welcomeTitle) {
  ...
  public static ActivityWelcomeBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityWelcomeBinding((ConstraintLayout) rootView, logoutButton, welcomeMessage,
          welcomeTitle);
    }
